        ...
        <div className="ti-panel-body">
          ...
          <div className="ti-solde-row">
            ...
            <div className="ti-operation-box">
              ...
              <div className="ti-operation-row">
                <select className="ti-input" value="Addition (+)" onChange={() => {}}>
          ...
          <div className="ti-balance-list-card">
            ...
            {PRODUCTS.filter(p => p.desc).map(p => (
              <div key={p.id} className="ti-balance-list-item" onClick={() => setSelected(p)}>
...
export default function TabInfo({
  form, set, committed, onSave, onCancel, savedFlash, onOpenNameModal,
  showRapport = true,
  onConnect   = null,
  autoConnect = false,
  ...
  function handleBalanceSave(product) {
    if (!product) return;
    const hours = Number(product.hours ?? product.balance ?? 0);
    const nextBalance = (Number(balance) || 0) + hours;
    setBalance(nextBalance);
    setEstimation(prev => prev + hours);
    ...
    if (onConnect) {
      ...
      navigate("/student-dashboard", {
        state: {
          ...
          returnTo: location.pathname || "/info",
        },
      });
    }
  }
  ...
  return (
    <>
      ...
      <section className="cp-section">
        <h2 className="cp-section-title">InformatioZns personnelles</h2>
