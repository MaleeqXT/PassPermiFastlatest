                          ...
                          >
                            {isLeadVisibleSlot ? (
                              <>
                                ...
                                <div className="cal-week-event-person"><div className="cal-week-event-avatar">{candidateAvatar ? <img src={candidateAvatar} alt={candidateName} /> : getInitials(candidateName)}</div><span title={candidateName}>Élève : {candidateName}</span></div>
                                <div className="cal-week-event-person"><div className="cal-week-event-avatar">{monitorAvatar ? <img src={monitorAvatar} alt={monitorName || "Moniteur"} /> : getInitials(monitorName || "Moniteur")}</div><span title={monitorName || "Moniteur non défini"}>Moniteur : {monitorName || "Non défini"}</span></div>
