...
export default function PropositionDrawer({ proposition, onClose, onCancel }) {
  const [showMapModal, setShowMapModal] = useState(false);

  const data = {
    name: proposition?.name ?? "Youzouria Tamime",
    phone: proposition?.phone ?? "",
  ...
  const avatarSrc = data.profilePhotoUrl || (data.media ? `${apiBase}/storage/${data.media}` : null);
